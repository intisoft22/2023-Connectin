            ...
            if json_loads:
                if json_loads['codestatus'] == 'E':
                    ...
                    for jloads in json_loads['response']:
                        for jload in jloads['category_list']:
                            print(jload)
...
class ProductAttributeValueParent(models.Model):
    ...
    parent_attribute_id = fields.Integer('parent_attribute_id')
...
class ProductAttributeValue(models.Model):
    ...
    display_value_name = fields.Char('display_value_name')
...
class ProductAttribute(models.Model):
    ...
    display_attribute_name = fields.Char('display_attribute_name')
    name = fields.Char('original_attribute_name')
    attribute_id = fields.Integer('Shopee attribute id')
    is_mandatory = fields.Boolean('is_mandatory')
    input_validation_type = fields.Char('input_validation_type')
    format_type = fields.Char('format_type')
    date_format_type = fields.Char('date_format_type')
...
#
#     parent_attribute_id = fields.Many2one('shopee.product.attribute', string='parent_attribute_id')
